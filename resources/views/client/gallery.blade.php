    ...
    @endif
      ...
      <div class="collapse navbar-collapse" id="main-navbar">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a href="{{url('client/blogs')}}" class="nav-link">Blog</a>
          </li>
          <li class="nav-item active">
              <a href="{{url('client/gallery')}}" class="nav-link" >gallery</a>
            </li>
          <li class="nav-item">
   ...
   <div class="vg-page page-portfolio" id="portfolio">
    <div class="container">
      <div class="text-center wow fadeInUp">
        <div class="badge badge-subhead">gallery</div>
      </div>
      ...
      @foreach($galleries as $gallery)
        <div class="grid-item graphic ui-ux wireframes wow zoomIn">
          ...
          <div class="img-place" data-src="uploads/gallery/{{$gallery->image}}" >
            <img src="../uploads/gallery/{{$gallery->image}}" alt="">
